class Bridge {
    ...
    getRouter(scriptUuid) {
        return this.routerMap[scriptUuid];
    }
    ...
    log(data) {
        if (this.debug) {
            console.log("JS>> [" + new Date().toISOString() + "] scriptUuid: " + this.scriptUuid + "; method: " + this.args["method"] + "; data: " + JSON.stringify(data)+"; pageUuid: " + this.pageUuid + ";");
        }
    }
