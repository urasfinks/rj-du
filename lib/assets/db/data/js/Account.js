if (bridge.args["method"] == "onActive") {
    constructor();
}

if (bridge.args["method"] == "constructor") {
    constructor();
}
...
if (bridge.args["method"] == "onFetchAccountData") {
...
if (bridge.args["method"] == "GetCodeResponse") {
...
if (bridge.args["method"] == "RequestConfirmCode") {
...
if (bridge.args["method"] == "onConfirmCodeResponse") {
    if (bridge.checkHttpResponse([])) {
        bridge.call("SetStorage", {
            "map": {
                "mail": bridge.pageArgs["mail"],
...
if (bridge.args["method"] == "onDataSync") {
    bridge.call("Hide", {"case": "customLoader"});
...
if (bridge.args["method"] == "RemoveLogout") {
...
if (bridge.args["method"] == "setNewName") {
...
if (bridge.args["method"] == "reSync") {
    bridge.util("dataSync", {});
}

if (bridge.args["method"] == "showGallery") {
    bridge.call("Show", {
        "case": "gallery",
        "onLoadImage": {
            "jsInvoke": "Account.js",
...
if (bridge.args["method"] == "onLoadImage") {
    bridge.call("DataSourceSet", {
        "uuid": "avatar",
